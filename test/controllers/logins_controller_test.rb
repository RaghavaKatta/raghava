...
class LoginsControllerTest < ActionController::TestCase
  ...
  test "should create login" do
    assert_difference('Login.count') do
      post :create, login: { address: @login.address, cell: @login.cell, gender: @login.gender, name: @login.name, userid: @login.userid }
    end
  ...
  test "should update login" do
    patch :update, id: @login, login: { address: @login.address, cell: @login.cell, gender: @login.gender, name: @login.name, userid: @login.userid }
    assert_redirected_to login_path(assigns(:login))
  end
